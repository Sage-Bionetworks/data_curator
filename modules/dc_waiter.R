...
dc_waiter <- function(stage=c("show", "update", "hide"), 
    ...
    if (isLogin) {
      ...
      if (stage == "show") {
        ...
        waiter_update(html = tagList(img(src = "synapse_logo.png", height = "120px"), 
        ...
        waiter_update(html = tagList(img(src = "synapse_logo.png", height = "120px"), 
                      h3("Looks like you're not logged in!"), span("Please ", a("login", 
      ...
      if (stage == "show") {
        waiter_show(html = tagList(spin_plus(), br(), h3(msg)), 
