...
### log in for testing not on server
synStore_obj <- syn_store("syn20446927", syn = syn)
...
for (i in seq_along(all_folders_list)) {
  ...
  path <- get_storage_manifest_path("10b3258a-1486-4663-9018-822b034dd84c" , all_folders_list[i])
...
# proj_folder_manifest_cells[is.na(proj_folder_manifest_cells)] <- 0
